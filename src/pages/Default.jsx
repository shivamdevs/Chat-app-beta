        ...
        <>
            {!user && <MobileView className={css.mvParent}>
                ...
                <div className={css.mbFooter}>
                    ...
                    <div className={css.mbBottom}>
                        By continuing to this website you agree to our <a href={app.pathname + "/legal"} target="_blank" rel="noopener noreferrer">Privacy policy</a> and <a href={app.pathname + "/legal/terms"} target="_blank" rel="noopener noreferrer">Terms of Usage</a>.
                    </div>
                </div>
            </MobileView>}
            {user && <Routes>
