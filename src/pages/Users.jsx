...
import Section, { SplitSection } from '../layouts/Section';
...
function Users({
    ...
    return (
        <>
            <SplitSection desktopview={isBrowser}>
                <Section splitted={true} desktopview={isBrowser}>
                ...
                {!loading && isBrowser && <Routes>
                    ...
                    <Route path="/" element={<Section splitted={isBrowser} desktopview={isBrowser}><img className={css.undraw} src="/assets/undraw.svg" alt="" /></Section>} />
                </Routes>}
            </SplitSection>
            {!loading && isMobile && <Routes>
                <Route path="/:bondid/*" element={<Panel back={back} navigate={navigate} user={user} userBondids={userBondids} usersDetails={usersDetails} />} />
                <Route path='/preview/*' element={<Preview back={back} />} />
                <Route path='/search' element={<Search me={user} navigate={navigate} back={back} users={usersDetails} history={usersHistory} />} />
            </Routes>}
